...
public class DialogueSystem : MonoBehaviour
{
    ...
    [SerializeField] 
    private KeyCode _skipKey = KeyCode.Return;
    ...
    private void HandleInput()
    {
        ...
        bool skipPressed = Input.GetKeyDown(_skipKey);
