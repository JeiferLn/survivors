...
public class Door : MonoBehaviour, IOpenable, ILockable, IKeyLockable, IInteractable
{
    ...
    [SerializeField]
    private bool _startsLocked = true;

    [ShowIf("_doorType", DoorType.Locked)]
    [SerializeField]
    private string _lockedMessage = "La puerta está bloqueada";
    ...
    [SerializeField]
    private string _requiredKeyId = "key_01";

    [ShowIf("_doorType", DoorType.KeyRequired)]
    [SerializeField]
    private string _noKeyMessage = "Necesitas una llave";

    [ShowIf("_doorType", DoorType.KeyRequired)]
    [SerializeField]
    private string _wrongKeyMessage = "Llave incorrecta";
    ...
    [
        Button("Test Unlock"),
        ShowIf("@UnityEngine.Application.isPlaying && _doorType == DoorType.Locked")
    ]
    private void TestUnlock() => Unlock();

    [
        Button("Test Key Unlock"),
        ShowIf("@UnityEngine.Application.isPlaying && _doorType == DoorType.KeyRequired")
    ]
